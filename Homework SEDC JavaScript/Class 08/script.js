...
let specificExerciseInput = document.getElementById("specificExercise");
let getExerciseButton = document.getElementById("getExerciseBtn");
...
function PrintExercise(exerciseNumber) {
    let exercise = vezbi[`vezba${exerciseNumber}`];

    if (exercise) {
      container.innerHTML = `<p> Vezba ${exerciseNumber}: ${exercise}</p>`;
  }   else {
...
getExerciseButton.addEventListener("click", function () {
  let specificExerciseNumber = specificExerciseInput.value;
  PrintExercise(specificExerciseNumber);
  specificExerciseInput.value = "";
});
...
function applyStyles() {
    ...
    getExerciseButton.style.backgroundColor = "blue";
    getExerciseButton.style.color = "white";
    getExerciseButton.style.padding = "10px";
    getExerciseButton.style.borderRadius = "5px";
}
